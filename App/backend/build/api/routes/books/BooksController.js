...
let BooksController = class BooksController extends tsoa_1.Controller {
    ...
    getAllBooks() {
        return __awaiter(this, void 0, void 0, function* () { return yield BookDAO_1.booksDAO.getAllBooks(); });
    }
    createBook(book) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteBook(isbn) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield BookDAO_1.booksDAO.deleteBook(isbn);
        });
    }
    editBook(book) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield BookDAO_1.booksDAO.editBook(book);
        });
    }
};
__decorate([
